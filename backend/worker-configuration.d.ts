/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 17474bf06c770b83284ba10e2079d362)
// Runtime types generated with workerd@1.20260911.1 2026-09-14 nodejs_compat
interface __BaseEnv_Env {
	TESTER_CODE_LIMITER: RateLimit;
	PUBLIC_LIMITER: RateLimit;
	PLAYER_LIMITER: RateLimit;
	PHOTO_ACK_LIMITER: RateLimit;
	PHOTO_TRANSFER_LIMITER: RateLimit;
	ENVIRONMENT: "test-store";
	PRESENCE_ENABLED: "false";
	TESTER_ACCESS_ENABLED: "false";
	SAFETY_ENFORCEMENT_ENABLED: "false";
	REVENUECAT_VERIFICATION_MODE: "demo";
	REVENUECAT_PLAY_ENVIRONMENT: "production";
	REVENUECAT_DELETION_ENABLED: "false";
	NOTIFICATIONS_ENABLED: "false";
	V2_ROOMS_ENABLED: "false";
	FIRST_STEPS_ENABLED: "false";
	RELAY_PHOTOS_ENABLED: "false";
	PRESET_REACTIONS_ENABLED: "false";
	REVENUECAT_API_VERSION: "2";
	REVENUECAT_ENTITLEMENT: "full_journey";
	PHOTO_DELIVERY_ENABLED: "false";
	PHOTO_TRANSFER_ENABLED: "false";
	SAFETY_PROFILES: DurableObjectNamespace<import("./src/index").SafetyProfile>;
	SAFETY_INBOX: DurableObjectNamespace<import("./src/index").SafetyInbox>;
	PLAYERS: DurableObjectNamespace<import("./src/index").Player>;
	ROOMS: DurableObjectNamespace<import("./src/index").Room>;
	ROOMS_V2: DurableObjectNamespace<import("./src/index").RoomV2>;
	PHOTO_TRANSFERS: DurableObjectNamespace<import("./src/index").PhotoTransfer>;
	PHOTO_TRANSFER_BUDGET: DurableObjectNamespace<import("./src/index").PhotoTransferBudget>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Player" | "Room" | "RoomV2" | "PhotoTransfer" | "PhotoTransferBudget" | "SafetyProfile" | "SafetyInbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PRESENCE_ENABLED" | "TESTER_ACCESS_ENABLED" | "SAFETY_ENFORCEMENT_ENABLED" | "REVENUECAT_VERIFICATION_MODE" | "REVENUECAT_PLAY_ENVIRONMENT" | "REVENUECAT_DELETION_ENABLED" | "NOTIFICATIONS_ENABLED" | "V2_ROOMS_ENABLED" | "FIRST_STEPS_ENABLED" | "RELAY_PHOTOS_ENABLED" | "PRESET_REACTIONS_ENABLED" | "REVENUECAT_API_VERSION" | "REVENUECAT_ENTITLEMENT" | "PHOTO_DELIVERY_ENABLED" | "PHOTO_TRANSFER_ENABLED">> {}
}
