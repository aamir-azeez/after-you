...
class AfterYouExport extends EditorExportPlugin:
	...
	func _get_android_dependencies(_platform: EditorExportPlatform, _debug: bool) -> PackedStringArray:
		return PackedStringArray(["com.revenuecat.purchases:purchases:10.15.1", "com.google.firebase:firebase-messaging:25.1.3", "org.jetbrains.kotlin:kotlin-stdlib:2.1.20", "androidx.core:core:1.8.0"])
